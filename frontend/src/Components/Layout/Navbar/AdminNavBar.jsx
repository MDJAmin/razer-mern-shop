...
export default function AdminNavbar({ handleShowText }) {
  ...
  return (
    <nav className="flex justify-between items-center px-6 py-4 bg-light dark:bg-dark text-gray dark:text-light shadow-md">
      ...
      {/* Mobile Menu */}
      <div
        className={`fixed top-0 right-0 h-full w-64 z-50 bg-light dark:bg-dark shadow-lg transform transition-transform duration-300 ease-in-out ${menuOpen ? "translate-x-0" : "translate-x-full"}`}
      >
